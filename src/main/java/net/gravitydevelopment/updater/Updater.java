...
public class Updater {
	...
	public boolean shouldUpdate(String localVersion, String remoteVersion) {
		String localVersionString = localVersion.replace(".", "");
		String remoteVersionString = remoteVersion.replace(".", "");
		if (localVersionString.length() == 2) {
			localVersionString = localVersionString + "0";
		}
		if (remoteVersionString.length() == 2) {
			remoteVersionString = remoteVersionString + "0";
		}
		int localVersionInt = Integer.parseInt(localVersionString);
		int remoteVersionInt = Integer.parseInt(remoteVersionString);
